...
Configuration file:  `/etc/dashcore/bcash.conf`  
...
dashcore user and group.  Access to bcash-cli and other dashd rpc clients
can then be controlled by group membership.

3b) Mac OS X

Binary:              `/usr/local/bin/dashd`  
Configuration file:  `~/Library/Application Support/DashCore/bcash.conf`  
...
Copy org.bcash.dashd.plist into ~/Library/LaunchAgents. Load the launch agent by
running `launchctl load ~/Library/LaunchAgents/org.bcash.dashd.plist`.
...
You will need to modify org.bcash.dashd.plist if you intend to use it as a
